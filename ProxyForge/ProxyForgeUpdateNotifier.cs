...
internal static class ProxyForgeUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-ProxyForge";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(ProxyForgeUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.ProxyForge, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
