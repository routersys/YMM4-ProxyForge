...
internal sealed class ProxyForgeVideoSourceWithScale : IVideoFileSource
{
    ...
    internal ProxyForgeVideoSourceWithScale(IVideoFileSource inner, IGraphicsDevicesAndContext devices, float proxyScale)
    {
        _inner = inner;
